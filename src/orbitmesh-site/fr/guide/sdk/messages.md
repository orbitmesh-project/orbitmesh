...
Atteindre un autre package - par nom, groupe, ou une portée de diffusion - nécessite une règle `Allow` sur la propre credential de l'appelant. Voir [Contrôle d'accès](/fr/guide/architecture/access-control).
